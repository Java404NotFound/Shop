		...
		<div class="container">
				...
				<div style="margin:0 auto; margin-top:10px;width:950px;">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<c:forEach items="${cart.cartIems}" var="entry">
							<tr class="active">
			...
			<div style="margin-right:130px;">
				...
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					...
					<a href="order?methodName=submitOrder">
...
function delProFromCart(pid){
	if(confirm("是否删除该项？？")){
		location.href="${pageContext.request.contextPath}/product?methodName=delProFromCart&pid="+pid;
	}
}
function clearCart(){
	if(confirm("是否删除该项？？")){
