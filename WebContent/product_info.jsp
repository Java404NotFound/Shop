	...
	<div class="container">
		<div class="row">
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<a href="${pageContext.request.contextPath}/product?methodName=productList&cid=${cid}&currentPage=${currentPage}">返回列表</a>
			</div>
			<div class="clear"></div>
...
function  addCart(){
	...
	location.href="${pageContext.request.contextPath}/product?methodName=AddProdctCart&pid=${product.pid}&buyNum="+buyNum;
