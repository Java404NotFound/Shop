		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
			    ...
			    <c:forEach  items="${hotProduct}" var="hotProduct">
					...
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						<a href="${pageContext.request.contextPath}/product?methodName=product_info&pid=${hotProduct.pid}">
							<img src="${pageContext.request.contextPath}/${hotProduct.pimage}" width="130" height="130" style="display: inline-block;">
						</a>
						<p><a href="${pageContext.request.contextPath}/product?methodName=product_info&pid=${hotProduct.pid}" style='color:#666'>${hotProduct.pname}</a></p>
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						<a href="${pageContext.request.contextPath}/product?methodName=product_info&pid=${newnewProduct.pid}">
							<img src="${pageContext.request.contextPath}/${newProduct.pimage}" width="130" height="130" style="display: inline-block;">
						</a>
						<p><a href="${pageContext.request.contextPath}/product?methodName=product_info&pid=${newnewProduct.pid}" style='color:#666'>${newProduct.pname}</a></p>
